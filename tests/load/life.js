...
export default function lifeLoadTest() {const r=http.get(`${base}${route}`,{redirects:0,tags:{product:"life",workflow:"route"}});check(r,{"life route responds":x=>x.status>=200&&x.status<400});sleep(1);}

...
export default function(){const r=http.get(`${base}/book/${encodeURIComponent(slug)}`,{tags:{product:"business",workflow:"public_booking"}});check(r,{"booking page responds":x=>x.status>=200&&x.status<400});sleep(1);}

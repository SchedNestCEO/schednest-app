...
export default function(){const r=http.get(`${base}${route}`,{redirects:0,tags:{product:"medical",workflow:"route"}});check(r,{"medical route responds":x=>x.status>=200&&x.status<400});sleep(1);}

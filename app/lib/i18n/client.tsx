...
const dictionaries: Record<SchedNestLanguage, Record<string, string>> = {
  en: {
    ...
    "deposit.policy": "CBWP: Custom Business-Written Policy",
    "deposit.policyHelper": "Write your own deposit rules. SchedNest shows this to the customer before they submit.",
    ...
    "deposit.businessPolicy": "Business deposit policy",
  ...
  es: {
    ...
    "deposit.title": "Depósitos y CBWP",
    ...
    "deposit.policy": "CBWP: Política escrita por el negocio",
    "deposit.policyHelper": "Escribe tus propias reglas de depósito. SchedNest se las muestra al cliente antes de enviar la solicitud.",
    ...
    "deposit.businessPolicy": "Política de depósito del negocio",

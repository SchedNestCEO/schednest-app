  ...
  return (
    <main className="torogoz-public-page min-h-screen px-6 py-10 text-white">
      <div className="mx-auto max-w-7xl space-y-6">
        <Link
          href="/admin"
          className="inline-flex rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm font-black text-gray-300 transition hover:bg-white/10 hover:text-white"
        >
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                          ...
                          <div className="rounded-full bg-edition-primary/10 px-3 py-1 text-xs font-black uppercase tracking-[0.2em] text-edition-primary">
                            {edit.status}
                          </div>
                        </div>
                        ...
                        <div className="mt-4 grid gap-4 md:grid-cols-[1fr_auto] md:items-end">
                          ...
                          <button
                            ...
                            className="rounded-2xl bg-edition-primary px-5 py-3 text-sm font-black text-black transition hover:bg-edition-primary-hover"
                          >
                            Save
                          </button>
                        </div>
